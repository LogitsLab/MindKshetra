...
export const en = {
  ...
  astroYoga: "Yoga",
  astroKarana: "Karana",
  panchangEyebrow: "Daily almanac",
  panchangTitle: "Panchang",
  panchangIntro:
    "The day's five limbs, tithi, nakshatra, yoga, karana, vaar, computed from the same ephemeris as your chart.",
  panchangSunrise: "Sunrise",
  panchangSunset: "Sunset",
  panchangPada: "Pada",
  panchangVaar: "Vaar",
  panchangUntil: "until",
  panchangEkadashiToday:
    "Today is {tithi}, a traditional day of fasting and remembrance.",
  panchangPurnimaToday: "Today is Purnima, the full moon.",
  panchangAmavasyaToday: "Today is Amavasya, the new moon.",
  panchangConvention:
  ...
  panchangWhyTitle: "Why today",
  panchangVotdTitle: "Verse of the day",
  panchangFestivalStory: "Today’s observance",
  ...
  milanTitle: "Milan",
  milanIntro:
    "The traditional Ashtakoota count between two saved people, read gently, as guidance for a conversation.",
  milanPickA: "First person",
  milanPickB: "Second person",
  milanCompute: "See the count",
  milanComputing: "Counting…",
  milanScoreOf: "{score} of 36 points",
  milanBandExcellent: "A naturally supportive match, by traditional counting.",
  milanBandGood: "A good match, by traditional counting.",
  milanBandAcceptable: "A workable match, by traditional counting.",
  milanBandNeedsDiscussion: "This count invites a deeper conversation.",
  milanNadiTitle: "About Nadi",
  milanNadiBody:
    "Nadi scored 0 in this count. Tradition treats this seriously, and classical texts also describe exceptions this calculator does not model. A learned astrologer weighs the whole chart, never one koota.",
  milanAskMadhav: "Talk it through with Madhav",
  milanCaveat:
    "Ashtakoota is traditional guidance, not a prediction. It weighs eight factors from the moon alone and says nothing about how two people actually treat each other. Many classical exceptions that cancel a low score are not modelled here. Treat a number as a conversation starter.",
  milanNeedTwo: "Save at least two people to compare their charts.",
  ...
  astroGlossNavamsa: "Vargas refine the Lagna chart: D3 siblings, D7 children, D9 partnership, D10 vocation, D12 parents.",
  ...
  astroChartStyleCircular: "Circular",
  astroSystemVedic: "Vedic",
  astroSystemKp: "KP",
  astroWheelRashi: "Rashi",
  astroWheelBhav: "Bhav",
  astroWheelCombine: "Combine",
  astroVargaD1: "Lagna (D1)",
  astroVargaD3: "Drekkana (D3)",
  astroVargaD7: "Saptamsa (D7)",
  astroVargaD12: "Dwadasamsa (D12)",
  astroPada: "Pada",
  astroEpheCaution:
    "This chart used the Moshier fallback, not Swiss Ephemeris. Degrees are approximate — treat them as a sketch, not a professional reading.",
  astroAskThisChart: "Ask about this chart",
  astroChartAttached: "Attached chart",
  astroStarterLagna: "What does this Lagna mean?",
...
export const hi: Record<keyof typeof en, string> = {
  ...
  astroYoga: "योग",
  astroKarana: "करण",
  panchangEyebrow: "दैनिक पंचांग",
  panchangTitle: "पंचांग",
  panchangIntro:
    "दिन के पाँच अंग, तिथि, नक्षत्र, योग, करण, वार, उसी एफ़ेमेरिस से, जिससे आपकी कुंडली बनती है।",
  panchangSunrise: "सूर्योदय",
  panchangSunset: "सूर्यास्त",
  panchangPada: "पद",
  panchangVaar: "वार",
  panchangUntil: "तक, ",
  panchangEkadashiToday: "आज {tithi} है, उपवास और स्मरण का पारंपरिक दिन।",
  panchangPurnimaToday: "आज पूर्णिमा है।",
  panchangAmavasyaToday: "आज अमावस्या है।",
  panchangConvention:
  ...
  panchangWhyTitle: "आज क्यों",
  panchangVotdTitle: "आज का श्लोक",
  panchangFestivalStory: "आज का पर्व",
  ...
  milanTitle: "मिलान",
  milanIntro:
    "दो सहेजे गए लोगों के बीच पारंपरिक अष्टकूट गणना, इसे बातचीत की दिशा देने वाले संकेत की तरह, सहजता से पढ़ें।",
  milanPickA: "पहला व्यक्ति",
  milanPickB: "दूसरा व्यक्ति",
  milanCompute: "मिलान देखें",
  milanComputing: "गणना हो रही है…",
  milanScoreOf: "36 में {score} अंक",
  milanBandExcellent: "पारंपरिक गणना में सहज रूप से अनुकूल मेल।",
  milanBandGood: "पारंपरिक गणना में अच्छा मेल।",
  milanBandAcceptable: "पारंपरिक गणना में निभ सकने वाला मेल।",
  milanBandNeedsDiscussion: "यह गणना एक गहरी बातचीत के लिए आमंत्रित करती है।",
  milanNadiTitle: "नाड़ी के विषय में",
  milanNadiBody:
    "इस गणना में नाड़ी को 0 अंक मिले। परंपरा इसे गंभीरता से लेती है, और शास्त्रों में ऐसे कई अपवाद भी हैं जो इसे निरस्त करते हैं, पर वे यहाँ गणित में शामिल नहीं हैं। विद्वान ज्योतिषी पूरी कुंडली देखते हैं, केवल एक कूट नहीं।",
  milanAskMadhav: "माधव से बात करें",
  milanCaveat:
    "अष्टकूट पारंपरिक मार्गदर्शन है, भविष्यवाणी नहीं। यह केवल चंद्रमा से जुड़े आठ पक्ष देखता है, यह नहीं कि दो लोग एक-दूसरे के साथ कैसा व्यवहार करते हैं। कम अंक को निरस्त करने वाले कई शास्त्रीय अपवाद यहाँ शामिल नहीं हैं। संख्या को बातचीत की शुरुआत मानें।",
  milanNeedTwo: "मिलान के लिए कम से कम दो लोगों की कुंडली सहेजें।",
  ...
  astroGlossNavamsa: "वर्ग लग्न कुंडली को गहरा करते हैं: D3 सहोदर, D7 संतान, D9 संबंध, D10 व्यवसाय, D12 माता-पिता।",
  ...
  astroChartStyleCircular: "वृत्ताकार",
  astroSystemVedic: "वैदिक",
  astroSystemKp: "के.पी.",
  astroWheelRashi: "राशि",
  astroWheelBhav: "भाव",
  astroWheelCombine: "संयुक्त",
  astroVargaD1: "लग्न (D1)",
  astroVargaD3: "द्रेष्काण (D3)",
  astroVargaD7: "सप्तमांश (D7)",
  astroVargaD12: "द्वादशांश (D12)",
  astroPada: "पद",
  astroEpheCaution:
    "यह कुंडली स्विस एफमेरिस नहीं, मोशियर विकल्प से बनी है। अंश अनुमानित हैं — पेशेवर पाठ की तरह न पढ़ें।",
  astroAskThisChart: "इस कुंडली से पूछें",
  astroChartAttached: "जुड़ी कुंडली",
  astroStarterLagna: "इस लग्न का क्या अर्थ है?",
