 ...
 * Chart invite copy points users to Astrology for full Jyotish (kept separate).
 *
...
export const en = {
  ...
  madhavIntro: "{name}, speak freely, type or use your voice. Madhav answers as a companion on the field: personal, grounded in real Gita verses, not as a therapist or doctor.",
  ...
  welcomeMadhav: "{name}, I am Madhav. Tell me what weighs on you, in words or by voice. I will meet you there, with the Gita beside us.",
  composerPlaceholder: "{name}, share what you’re facing…",
...
export const hi: Record<keyof typeof en, string> = {
  ...
  madhavIntro: "{name}, खुलकर कहें, लिखें या आवाज़ से बोलें। माधव साथी की तरह उत्तर देते हैं, गीता के वास्तविक श्लोकों पर आधारित, चिकित्सक या संकट सेवा नहीं।",
  ...
  welcomeMadhav: "{name}, मैं माधव हूँ। जो बोझ मन पर है, शब्दों में या आवाज़ से कहें। मैं वहीं मिलूँगा, गीता साथ लेकर।",
  composerPlaceholder: "{name}, जो मन में है, लिखें या बोलें…",
