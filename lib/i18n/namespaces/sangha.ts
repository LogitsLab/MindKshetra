...
export const en = {
  ...
  pathNotStarted: "Not started",
  pathInProgress: "In progress",
  pathArcEyebrow: "Longer arcs",
  pathArcTitle: "Walk with the Gita",
  ...
  pathHideAllDays: "Show nearby days",
  pathBridgeMed: "Sitting course",
  pathDay: "Day {n}",
...
export const hi: Record<keyof typeof en, string> = {
  ...
  pathNotStarted: "अभी शुरू नहीं",
  pathInProgress: "चल रहा है",
  pathArcEyebrow: "लंबे चाप",
  pathArcTitle: "गीता के साथ चलें",
  ...
  pathHideAllDays: "आसपास के दिन देखें",
  pathBridgeMed: "बैठने का पाठ्यक्रम",
  pathDay: "दिन {n}",
